        ...
        <table class="striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="./edit.php?id=<?php echo $data['idcliente']?>" class="btn-floating blue"><i class="material-icons">edit</i></a></td>
                    <td><a href="#modal<?php echo $data['idcliente']?>" class="btn-floating red modal-trigger"><i class="material-icons">delete</i></a></td>
                    <!-- Modal Structure -->
                    <div id="modal<?php echo $data['idcliente']?>" class="modal">
                        <div class="modal-content">
                        <h4>Opa!</h4>
                        <p>Tem certeza que deseja excluir essed cliente?</p>
                        </div>
